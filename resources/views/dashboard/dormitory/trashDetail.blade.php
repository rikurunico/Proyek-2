...
@section('container')
    ...
    <div class="col-lg-8 p-0 mb-3 mb-sm-4">
        <a class="btn btn-primary me-3 w-sm-100 mb-sm-1" href="{{ route($dormitory_route["trashIndex"]) }}">Kembali ke Data Tabel</a>
        <a class="btn btn-warning me-3 w-sm-100 mb-sm-1" href="{{ route($dormitory_route["trashRestore"], $dormitory->id) }}">Restore Data</a>
